...
public class Admissions {
    ...
    public static double blindScore(Applicant app) {
        ...
        score += app.extra * 0.05;
        score += app.essay * 0.15;
        score += app.rec * 0.15;
    ...
    public static double awareScore(Applicant app) {
        ...
        if (app.legacy) score -= 0.1;             // legacy advantage
        if (app.local) score += 0.0;              // local preference
        if (app.ethnicity != "White") score += 0.02; //ethnicity preference 
